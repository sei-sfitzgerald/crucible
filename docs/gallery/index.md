...
1. On the Gallery Archive section, select the article to be edited and click **Edit** on the article's card.
...
To save these settings, click **Save** and select the desired permissions to be assigned by checking the box next to the user.
...
3. Select the user to be edited and click **Edit** next to the user.
...
1. Click the **Settings Cog**.
2. Navigate to the **Users** tab.
3. Select the user to be deleted and click the **Trash Can** next to the user.
...
3. Select the collection to be edited and click **Edit** next to the collection.
...
1. Click the **Settings Cog**.
2. Navigate to the **Collections** tab.
3. Select the collection to be deleted and click the **Trash Can** next to the collection.
...
| **Collection** | Dropdown Text | Select the collection that this card should be part of | Demonstration #1 |
...
3. Select the card to be edited and click **Edit** next to the card.
...
1. Click the **Settings Cog**.
2. Navigate to the **Cards** tab.
3. Select the card to be deleted and click the **Trash Can** next to the card.
...
3. Select the article to be edited and click **Edit** next to the article.
...
1. Click the **Settings Cog**.
2. Navigate to the **Articles** tab.
3. Select the article to be deleted and click the **Trash Can** next to the article.
...
3. Select the exhibit to be edited and click **Edit** next to the exhibit.
...
1. Click the **Settings Cog**.
2. Navigate to the **Exhibits** tab.
3. Select the exhibit to be deleted and click the **Trash Can** next to the exhibit.
...
1. Click the **Settings Cog**.
2. Navigate to the **Exhibits** tab.
3. Click **Copy** next to the exhibit to be copied.
