...
Add tasks in the Scenario Templates screen by clicking the **+** icon. Complete the same task information as you did when you created a new task.
...
After tasks have been executed, results are displayed in the task details. Each task is expandable. You will see a result listed for every single time that task is executed.
